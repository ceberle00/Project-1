...
public:
    ...
    int Start(const std::string& input) {
        newLines = 0; //MAYBE SAYING HOW MANY NEWLINES THERE ARE
        inputRead = 0; //INPUT READ BASICALLY A TRUE/FALSE, EITHER 0 OR 1 TO SHOW IF IT WAS SUCSESSFULLY READ
        index = 0; 
        S0(input);
        return inputRead;
    }
    ...
    //use this at end of function, still don't know what the colonautomaton class does??
